...
''' This script uses the gobs module to create a spreadsheet with all exon counts from a set of samples. Each column in the
spreadsheet will be labeled with the bam file name. This is primarily useful for B and W type samples'''
